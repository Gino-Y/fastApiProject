...
class City(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)  # autoincrement自增长
    ...
    data = relationship('Data', back_populates='city')  # Data 是关联的类名，back_populates来指定反相访问的属性名
    ...
    def __repr__(self):
        return f'{self.country}_{self.qrovince}'
...
class Data(Base):
    ...
    city = relationship('City', back_populates='data')  # City 是关联的类名，back_populates来指定反相访问的属性名
